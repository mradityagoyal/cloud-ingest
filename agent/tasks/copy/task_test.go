...
func tCopySpec(sf, db, do string, egn, fb, fm, bc, btc int64, crc uint32, ruID string) *taskpb.CopySpec {
...
func TestCheckCopyTaskSpec(t *testing.T) {
	...
	var tests = []struct {
		...
		// Non-resumed copy.
		{tCopySpec("f", "b", "o", 0, 0, 0, 0, 0, 0, ""), w{false, ""}},
		{tCopySpec("", "b", "o", 0, 0, 0, 0, 0, 0, ""), w{false, "empty SrcFile"}},
		{tCopySpec("f", "", "o", 0, 0, 0, 0, 0, 0, ""), w{false, "empty DstBucket"}},
		{tCopySpec("f", "b", "", 0, 0, 0, 0, 0, 0, ""), w{false, "empty DstObject"}},
		{tCopySpec("f", "b", "o", -1, 0, 0, 0, 0, 0, ""), w{false, "invalid ExpectedGen"}},
		...
		{tCopySpec("f", "b", "o", 0, 20, 1, 10, 99, 10, ""), w{true, "empty ResumableUploadId"}},
	}

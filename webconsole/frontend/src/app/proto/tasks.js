...
$root.JobRunStatus = (function() {

    /**
     * Properties of a JobRunStatus.
     * @exports IJobRunStatus
     * @interface IJobRunStatus
     */
     ...
     */
    function JobRunStatus(properties) {
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @function create
     * @memberof JobRunStatus
     * @static
     * @param {IJobRunStatus=} [properties] Properties to set
     * @returns {JobRunStatus} JobRunStatus instance
     */
    JobRunStatus.create = function create(properties) {
        return new JobRunStatus(properties);
    };
     ...
     * @memberof JobRunStatus
     * @static
     * @param {IJobRunStatus} message JobRunStatus message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    JobRunStatus.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    JobRunStatus.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {JobRunStatus} JobRunStatus
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    JobRunStatus.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.JobRunStatus();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            default:
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    JobRunStatus.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    JobRunStatus.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        return null;
    };
     ...
     * @returns {JobRunStatus} JobRunStatus
     */
    JobRunStatus.fromObject = function fromObject(object) {
        if (object instanceof $root.JobRunStatus)
            return object;
        return new $root.JobRunStatus();
    };
     ...
     * @memberof JobRunStatus
     * @static
     * @param {JobRunStatus} message JobRunStatus
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    JobRunStatus.toObject = function toObject() {
        return {};
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    JobRunStatus.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

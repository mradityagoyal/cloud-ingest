...
//TODO:(adityagoyal) check with @thobrla about reusing this table. 
//var (
...
type CRC32UpdatingWriter struct {
	writer io.Writer
	curCRC *uint32
}
...
func NewCRC32UpdatingWriter(w io.Writer, currentCRC *uint32) io.Writer {
	return &CRC32UpdatingWriter{writer: w, curCRC: currentCRC}
}

// Read implements the io.Reader interface.
func (cr *CRC32UpdatingWriter) Write(buf []byte) (n int, err error) {
	if n, err = cr.writer.Write(buf); err != nil {
		return 0, err
	}
